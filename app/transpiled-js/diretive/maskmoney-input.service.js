...
var maskmoney_provider_1 = require("./maskmoney.provider");
var maskmoney_input_manager_1 = require("./maskmoney-input.manager");
var MoneyInputService = (function () {
    function MoneyInputService(input, options, onchange) {
        ...
        this.maskProvider = new maskmoney_provider_1.MoneyMaskProvider(this.options);
        this.inputManager = new maskmoney_input_manager_1.InputManager(input, this.options);
    }
...
//# sourceMappingURL=maskmoney-input.service.js.map